...
const AboutPage = () => {
  ...
  const skills = {
    ...
    backend: [
      ...
      { name: "Authentication & Security", level: 87, icon: CheckCircle },
    ],
    telegram: [
  ...
  const values = [
    {
      icon: Target,
      title: "Quality First",
      description: "Delivering high-quality, maintainable code that stands the test of time.",
    },
    {
      icon: Zap,
      title: "Fast Delivery",
    ...
    },
    {
      ...
      description: "Understanding client needs and providing solutions that exceed expectations.",
    },
    {
      icon: BookOpen,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                ...
                <span className="text-blue-400 font-semibold">6 years of experience</span>{" "}
                specializing in web development and Telegram automation solutions.
              </p>
            ...
            >
              <div className="relative w-full aspect-square max-w-md mx-auto">
                ...
                {/* Image Container */}
                <div className="relative bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-3xl p-2 backdrop-blur-sm border border-gray-700">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p>
                My journey into programming began <span className="text-blue-400 font-semibold">6 years ago</span> when
                I wrote my first line of code. What started as curiosity quickly turned into a
                passion that shaped my career path.
              </p>
              <p>
                Over the years, I've evolved from building simple HTML pages to creating{" "}
                <span className="text-purple-400 font-semibold">complex full-stack applications</span> and{" "}
                <span className="text-blue-400 font-semibold">sophisticated Telegram bots</span>. Each project taught me
                something new, and each challenge made me a better developer.
              </p>
              <p>
                Today, I specialize in creating modern web applications using React, Next.js, and
                Node.js, as well as developing advanced Telegram solutions including bots, mini
                apps, and account automation tools. I'm passionate about writing clean, maintainable
                code and delivering solutions that exceed client expectations.
              </p>
              <p>
                When I'm not coding, you'll find me exploring new technologies, contributing to
                open-source projects, or sharing my knowledge with the developer community. I
                believe in continuous learning and always staying ahead of the curve.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            {experience.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  {/* Icon */}
                  <div className={`flex-shrink-0 w-16 h-16 bg-gradient-to-br ${item.color} rounded-2xl flex items-center justify-center shadow-lg`}>
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-full font-bold hover:bg-white/20 transition-colors flex items-center gap-2"
                  >
                    <Mail className="w-5 h-5" />
                    Contact Me
                  </motion.button>
